...
class DistanceGrid(Grid):
    ...
    def contents_of(self, cell):
        if self.distances and (cell in self.distances):
            ...
            intensity = self.distances[cell] / maxDistance

            cell.contents[constants.MODE_DISTANCE] = self.distances[cell]
            cell.contents[constants.MODE_FLOOD] = intensity
            # if cell in self.path:
            #     cell.contents[constants.MODE_PATH] = self.distances[cell]
